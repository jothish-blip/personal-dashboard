...
export default function DesktopNav({
  ...
  return (
    <>
      <nav className="hidden md:block w-full px-4 lg:px-6 mt-4 relative z-[1000] select-none">
        <div
        ...
        >
          ...
          <div className="relative h-[74px] px-6 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <div
                  className={`relative w-8 h-8 rounded-full overflow-hidden flex items-center justify-center shrink-0 border ${
              ...
              <>
                ...
                >
                  <div className="flex flex-col items-center justify-center pt-4 pb-3">
                    <div
                      className={`w-14 h-14 rounded-full flex items-center justify-center overflow-hidden shrink-0 border mb-3 ${
                        isDarkMode
                          ? "bg-[#000000] border-white/[0.05]"
                  ...
                  <div className="space-y-0.5 mb-2">
                    ...
                    <div
                      className={`w-full px-3 py-2 rounded-[14px] text-[13.5px] font-medium flex items-center justify-between transition-colors ${
