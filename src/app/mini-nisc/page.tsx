              ...
              <div className="flex overflow-x-auto no-scrollbar w-full [&::-webkit-scrollbar]:hidden">
                {(["editor", "analytics", "history", "media"] as const).map((v) => (
                  <button 
                    ...
                    className={`px-4 md:px-6 py-3 text-xs md:text-sm font-semibold uppercase tracking-wide border-b-2 transition-colors flex items-center gap-2 whitespace-nowrap ${
                      system.view === v 
